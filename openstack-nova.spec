...
done < etc/nova/start/nova-dist.conf
...
install -p -D -m 640 etc/nova/start/nova-dist.conf %{buildroot}%{_datadir}/nova/nova-dist.conf
...
install -p -D -m 755 etc/nova/start/openstack-nova-api %{buildroot}%{_initrddir}/openstack-nova-api
install -p -D -m 755 etc/nova/start/openstack-nova-cert %{buildroot}%{_initrddir}/openstack-nova-cert
install -p -D -m 755 etc/nova/start/openstack-nova-compute %{buildroot}%{_initrddir}/openstack-nova-compute
install -p -D -m 755 etc/nova/start/openstack-nova-network %{buildroot}%{_initrddir}/openstack-nova-network
install -p -D -m 755 etc/nova/start/openstack-nova-objectstore %{buildroot}%{_initrddir}/openstack-nova-objectstore
install -p -D -m 755 etc/nova/start/openstack-nova-scheduler %{buildroot}%{_initrddir}/openstack-nova-scheduler
install -p -D -m 755 etc/nova/start/openstack-nova-conductor %{buildroot}%{_initrddir}/openstack-nova-conductor
install -p -D -m 755 etc/nova/start/openstack-nova-xvpvncproxy %{buildroot}%{_initrddir}/openstack-nova-xvpvncproxy
install -p -D -m 755 etc/nova/start/openstack-nova-console %{buildroot}%{_initrddir}/openstack-nova-console
install -p -D -m 755 etc/nova/start/openstack-nova-consoleauth %{buildroot}%{_initrddir}/openstack-nova-consoleauth
install -p -D -m 755 etc/nova/start/openstack-nova-metadata-api %{buildroot}%{_initrddir}/openstack-nova-metadata-api
install -p -D -m 755 etc/nova/start/openstack-nova-cells %{buildroot}%{_initrddir}/openstack-nova-cells
install -p -D -m 755 etc/nova/start/openstack-nova-spicehtml5proxy %{buildroot}%{_initrddir}/openstack-nova-spicehtml5proxy
install -p -D -m 755 etc/nova/start/openstack-nova-novncproxy %{buildroot}%{_initrddir}/openstack-nova-novncproxy

# Install sudoers
install -p -D -m 440 etc/nova/start/nova-sudoers %{buildroot}%{_sysconfdir}/sudoers.d/nova

# Install logrotate
install -p -D -m 644 etc/nova/start/nova.logrotate %{buildroot}%{_sysconfdir}/logrotate.d/openstack-nova
...
install -p -D -m 644 etc/nova/start/nova-ifc-template %{buildroot}%{_datarootdir}/nova/interfaces.template

# Install upstart jobs examples
install -p -m 644 etc/nova/start/openstack-nova-api.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-cert.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-compute.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-network.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-objectstore.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-scheduler.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-conductor.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-xvpvncproxy.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-console.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-consoleauth.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-cells.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-spicehtml5proxy.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-novncproxy.upstart %{buildroot}%{_datadir}/nova/
install -p -m 644 etc/nova/start/openstack-nova-metadata-api.upstart %{buildroot}%{_datadir}/nova/
...
install -p -D -m 644 etc/nova/start/nova-polkit.pkla %{buildroot}%{_sysconfdir}/polkit-1/localauthority/50-local.d/50-nova.pkla

# Install novncproxy service options template
install -d %{buildroot}%{_sysconfdir}/sysconfig
install -p -m 0644 etc/nova/start/openstack-nova-novncproxy.sysconfig %{buildroot}%{_sysconfdir}/sysconfig/openstack-nova-novncproxy
